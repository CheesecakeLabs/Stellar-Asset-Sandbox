...
// IsUserSuperAdmin mocks base method.
func (m *MockUserRepo) IsUserSuperAdmin(id string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsUserSuperAdmin", id)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsUserSuperAdmin indicates an expected call of IsUserSuperAdmin.
func (mr *MockUserRepoMockRecorder) IsUserSuperAdmin(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsUserSuperAdmin", reflect.TypeOf((*MockUserRepo)(nil).IsUserSuperAdmin), id)
}

...
export const AUTH_REQUIRED_FLAG = 'AUTH_REQUIRED_FLAG'
export const AUTH_REVOCABLE_FLAG = 'AUTH_REVOCABLE_FLAG'
export const AUTH_CLAWBACK_ENABLED = 'AUTH_CLAWBACK_ENABLED'
export const SEP8 = 'SEP8'
...
export const assetFlags = [
  ...
  },
  {
    ...
    description:
      'When active, this flag enables the ‘Clawback’  functionality for this asset.  It allows for the asset manager to clawback funds from a target account holding balance in its assets. The clawback amount is burned from the circulating supply as result. To enable the Clawback flag, it is necessary to enable the Freeze flag as a requirement.',
    isChecked: false,
    isDisabled: false,
  },
  {

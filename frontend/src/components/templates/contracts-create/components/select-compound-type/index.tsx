...
export const SelectCompoundType: React.FC<ISelectCompoundType> = ({
  compoundType,
  setCompoundType,
}) => {
  return (
    <Container variant="primary" p="0" h="2rem" mb="1rem">
      <Flex>
        {['Simple interest', 'Compound interest'].map((type, index) => (
          <Button
            key={index}
            variant={
              compoundType === type ? 'menuButtonSelected' : 'menuButton'
            }
